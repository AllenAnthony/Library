...
<?php
	...
	$data=mysql_query("select * from record , book where card_id='$card_id' and book.book_id=record.book_id ") or die("<br> 数据表无记录<br>");
	...
	print '</table>';
	print "<hr><a href=returnbook.php>返回</a>";
?>
</body>
</html>